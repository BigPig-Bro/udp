...
generate
    ...
    if (P_RGMII_MODE == 2'd2) begin : gen_gmii_1g
        ...
        Gowin_DDR_IN Gowin_DDR_IN_m0(
            .clk    (o_usr_clk          ), //input clk
            .din    ({i_gmii_rx_data, i_gmii_rx_valid, i_gmii_rx_err}  ), //input [9:0] din
            .q      ({unused_rx_data, o_rx_data, o_rx_dv, o_rx_er}     ) //output [19:0] q
        );
        ...
        /////////////////////////////////////////////////////////////////////////////
        logic                           usr_clk_div, i_gmii_rx_clk_d;
        logic [7:0]                     rx_data_d;
        logic                           rx_dv_d;
        logic                           rx_er_d;
        logic [3:0]                     rxd_q;
