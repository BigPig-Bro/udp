...
localparam [ 1:0] RGMII_MODE    = 2'd2; // 0:10M 1:100M 2:1G
localparam [ 4:0] P_IDELAY_TAPS = 5'd12; 
localparam        P_USR_CLK     = (RGMII_MODE == 2'd0) ? 2_500_000 / 2 :
                                  (RGMII_MODE == 2'd1) ? 25_000_000 / 2 :
                                                         125_000_000;
